...
(defvar adict-hash
  ...
  (let ((hash (make-hash-table :test 'equal)))
    ...
    (adict-add-word hash 5
                    ...
                    "hur" "sedan" "någon" "mej" "när" "tycker" "säga"
    ...
    ;;  "sverige" "nej" "vill" "till" "medan" "utan"
    ...
    (adict-add-word hash 10
                    ...
                    ;;
                    ;; Based on: http://helmer.aksis.uib.no/nta/ord10000.txt and
                    ;; http://www.nb.no/sprakbanken/show?serial=oai%3Anb.no%3Asbr-29&lang=nb
                    ;; (Some words are just opposed to words in the Swedish or
                    ;; Danish lists.)
                    "hva" "annet" "forteller" "annen" "utenfor"
                    "regjeringen" "penger" "dessuten" "innen" "drept"
                    "én" "uker" "veien" "fornøyd" "dere" "hverandre"
                    "høyere" "antall" "sykehus" "viktigste" "krever"
                    "uken" "jobber" "kvinnen" "understreker"
                    "ytterligere" "myndighetene" "pengene" "høyt"
                    "brukes" "utviklingen" "øke" "innenfor" "årsaken"
                    "mulighet" "åpnet" "muligheter" "spennende"
                    "bekrefter" "hodet" "selge" "flertall"
                    "opplysninger" "norge" "hevdet" "øker" "velger"
                    "eier" "avgjørende"
                    "utenlandske" "økning" "sammenheng" "velge"
                    "muligheten" "fortelle" "pågrepet" "sykehuset"
                    "legges" "gjøres" "oppdaget" "kommunene"
                    "foreldrene"
                    "elevene" "aksjer" "partene" "forhandlingene"
                    "hvite" "kaller" "problemene" "virksomhet"
                    "sikkerhet" "avsluttet" "grensen" "tilfeller"
                    "greit" "settes" "forsøkte" "bekreftet"
                    "sterkere" "forsøker" "selskaper" "dro"
                    "pasienter" "nærheten" "seieren"
                    "oppgave" "annerledes" "brudd" "undersøkelse"
                    "sjelden" "utviklet" "partiene" "undersøkelsen"
                    "drepte" "endringer" "fra" "ble" "hennes"
                    "nå" "være" "selv" "vært" "gikk" "sammen"
                    "hvordan" "sier" "fikk" "noen" "nevnt"
                    "avskrekkende" "forekomme" "utmerket" "kjøre"
                    "kjørte" "kjører" "leser" "leste" "gjøre"
                    "ifølge" "disse" "fortsatt" "allerede" "ønsker"
                    "løpet" "mennesker" "funnet" "vanskelig"
                    "kjedelig" "uke" "betyr" "utsagn" "medarbeider"
                    "spurt" "flertydighet" "språklig" "språklige"
                    "opptellingen" "avgrensede" "alminnelig"
                    "alminnelige" "henger" "likegyldig" "vesentlige" "vesentlig"
                    )
    ;; Don't use:
    ;;  "ham" "og" "i" "det" "på" "at" "ikke" "jeg"  "også" "bare"
    ;;  "hvor"  "siden" "hun" "andre" "hadde" "henne" "etter"
    ...
    (adict-add-word hash 15 ;; Norwegian nynorsk (nn)
                    ...
                    ;; /Norsk
                    ;; http://www.nb.no/sprakbanken/show?serial=oai%3Anb.no%3Asbr-8&lang=nb
                    "sjølv" "kva" "berre" "kvar" "kjem"
                    "dykkar" "deira" "fekk" "noko" "desse" "gong"
                    "vere" "ikkje" "nokon" "eit" "mykje" "frå"
                    "bryggje" "dagar" "korleis" "kven" "inkje"
                    "nokre" "leike" "kaffi" "stova" "meir" "sjå"
                    "såg" "dei" "helsar" "kvifor" "garden" "dårleg"
                    "bere" "gjere" "høyre" "blei" "saum" "låg" "ho"
                    "tek" "spurde" "hundar" "herleg" "hausten"
                    "heiter" "følgje" "gutar" "såleis" "attmed"
                    "gøyme" "ringjer" "trufast" "kyrkja" "skunde"
                    "hugse" "vaknar" "hugsa" "auge" "vore" "seinare"
                    "finst" "medan" "heil" "nytta" "kjend" "heile"
                    "aust" "innbyggjarar" "fødd" "dømes" "døydde"
                    "særleg" "songen" "høgaste" "sokn" "kjende"
                    "vatn" "vanleg" "byrja" "inneheld" "artar"
                    "einaste" "øyane" "høyrer" "vanlegvis" "leiar"
                    "nordlege" "kvarandre" "skriva" "byrjinga"
                    "søraust" "oftast" "difor" "auka" "såkalla"
                    "eigne" "strekkjer" "vestlege" "talet"
                    "hovudstaden" "høgre" "nyttar" "innbyggjarane"
                    "skil" "austsida" "vitja" "brukar" "noverande"
                    "mogleg" "umogleg" "tilgjengeleg" "brukast"
                    "heilage" "kjelder" "austlege" "vanskeleg" "òg"
                    "noreg" "gjekk" "budde" "utgjer" "vatnet"
                    "tidlegare" "namn" "kvart" "heilt" "framleis"
                    "hovudsakleg" "hennar" "særs" "munnar" "attende"
                    "gut" "gutane" "månadene" "skilnadene"
                    "skilnader" "skilnaden" "føtene" "søner" "sønene"
                    "brør" "brørne" "velja" "menner" "venen" "vener"
                    "venene" "føremon" "meining" "meininga"
                    "meiningar" "hending" "hendinga" "øyra" "øyro"
                    "døme" "vori" "skrivi" "lesi" "vart" "ligg"
                    "vert" "kalla" "me" "no" "fleire" "vera"
                    "millionar" "saman" "gjer" "kome" "gjera" "gje"
                    "eitt" "halde" "skulen" "kommunane" "laurdag"
                    "sjølvsagt" "ordførar" "truleg" "teke" "personar"
                    "seie" "ønskjer" "dessutan" "politikarane"
                    "elevane" "endå" "eigen" "enno" "eige" "seia"
                    "synest" "utanfor" "tilbod" "ynskjer" "kommunar"
                    "tidleg" "opna" "ifølgje" "tysdag" "eine"
                    "elevar" "håpar" "reknar" "nemleg" "verta"
                    "allereie" "vidaregåande" "pengane" "milliardar"
                    "ordføraren" "eiga" "offentlege" "eigentleg"
                    "hevdar" "skikkeleg" "verkeleg" "høgare"
                    "offentleg" "endeleg" "heldt" "nærare" "bilete"
                    "nyleg" "naturleg" "ventar" "setja"
                    )
    ;; Don't use: ;; "ein" "sidan" "utan" "elles" "vil"
